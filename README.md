# 🌱 Smart Irrigation Using Machine Learning Model
---
...
The model outputs **ON/OFF** irrigation statuses for **three distinct land parcels**, enabling **precision irrigation** and resource optimization.
